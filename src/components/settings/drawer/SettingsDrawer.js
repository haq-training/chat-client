...
export default function SettingsDrawer() {
  ...
  return (
    <>
      {!open && <ToggleButton open={open} notDefault={notDefault} onToggle={onOpen} />}
      ...
      >
        ...
        <Scrollbar sx={{ p: SPACING, pb: 0 }}>
          ...
          <Block title="Màn hình rộng" tooltip="Chỉ có tác dụng với màn hình rộng">
            <StretchOptions />
          </Block>

          <Block title="Màu chủ đạo">
            <ColorPresetsOptions />
          </Block>
        </Scrollbar>
