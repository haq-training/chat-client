const RECRUITMENT_TITLE = ['Tuyển dụng 1', 'Tuyển dụng 2', 'Tuyển dụng 3', 'Tuyển dụng 4', 'Tuyển dụng 5'];

const RECRUITMENT_CONTENT = [
...
export const recruitment = [...Array(5)].map((_, index) => ({
  title: RECRUITMENT_TITLE[index],
  content: RECRUITMENT_CONTENT[index],
}));
