...
export const _notifications = [...Array(5)].map((_, index) => ({
  id: _mock.id(index),
  title: ['Đơn hàng', 'Nhân viên kinh doanh 1', 'Tin nhắn chưa đọc', 'Nhân viên kinh doanh 2', 'Đơn hàng'][index],
  description: [
    'đang chờ được vận chuyển',
    'vừa xác nhận chấm công hôm nay',
    '5 tin nhắn',
    'đã gửi báo cáo xuất hóa đơn',
