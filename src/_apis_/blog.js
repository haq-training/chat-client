...
import { postsBlog } from '../_mock/posts';
...
export const posts = [...Array(15)].map((_, index) => {
  return {
    id: mockData.id(index),
    cover: postsBlog[index].cover,
    title: postsBlog[index].title,
    description: postsBlog[index].description,
    ...
    comments: postsBlog[index].comment,
  };
});
