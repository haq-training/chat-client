    ...
    <Box sx={{ width: 320, height: '100vh' }}>
      <Stack sx={{ height: '100%' }}>
        ...
        <Scrollbar
          ...
          speed={0.8}
          smoothScrolling
          contentProps={{ style: scrollbarStyles }}
          trackProps={{ style: scrollbarStyles }}
          thumbProps={{ style: scrollbarStyles }}
          horizontalScrollbarStyle={scrollbarStyles}
          verticalScrollbarStyle={scrollbarStyles}
          thumbHoverStyle={scrollbarHoverStyles}
        >
